    ...
    <>
      ...
      <div className="cat-root">
        ...
        <nav className="cat-navbar">
          <a href="/home" className="cat-brand">
        ...
        <div className="cat-hero">
          <div className="cat-hero-inner">
            <div className="cat-breadcrumb">
              <a href="/home">Home</a> › <span style={{color:"rgba(255,255,255,.6)"}}>Courses</span> › <span style={{color:"rgba(255,255,255,.6)"}}>{category}</span>
            </div>
        ...
        <div className="cat-content">
          ...
          {sorted.length === 0 ? (
            <div className="cat-empty">
              ...
              <a href="/home" className="cat-browse-btn">← Browse All Courses</a>
            </div>
          ) : (
